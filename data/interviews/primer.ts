...
const data: Interview = {
  ...
  company: {
    name: "Github",
    logo: `
      <svg viewBox="0 0 16 16" version="1.1" width="24" height="24">
        <path
          fill="currentColor"
  ...
  interviewee: {
    ...
    photoUrl:
      "https://pbs.twimg.com/profile_images/1531246628673359872/S5nb3hbZ_400x400.jpg",
  ...
  interview: {
    description:
      "Primer exists for more than 10 years now and powers most of the Github products. Learn more about the team and the challenges they face during its development.",
    date: "July 27, 2022",
    items: [
      {
        question:
