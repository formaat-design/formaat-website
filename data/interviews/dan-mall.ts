    ...
    items: [
      ...
      },
      {
        ...
        answer: [
          ...
          "There were times when I was mostly just administrating, being an official CEO, and not working with clients directly, but working with our teams who helped clients. And then there were also periods where I was very hands-on with clients, creating deliverables, creating a design system, documentation and designs, and code and all that stuff.",
          "Towards the end, most of my role became coaching in-house teams. So the last two years, I worked directly with in-house teams and coached them. So not creating anything myself but helping people figure out what to create, when to create it, and how to work on their design systems. That way, they knew how to do it instead of just getting dumped a bunch of deliverables on them.",
        ],
      },
      {
      ...
      },
      {
        ...
        answer: [
          "I think so, and much of it is predicated on the organization's culture. I've seen consistently that larger companies usually move more slowly regardless of their size because the culture can only accept a particular pace or is used to a particular pace.",
          "That influences very directly the amount of work and the pace of work a team of any size can do when there's just so fast they can move. I've worked with startups, and whether they have a team of one or a team of ten, they can move much faster. Their scale of change is much more manageable than at a larger company, which tends to move slowly because one change has significant impacts across multiple products.",
        ],
      },
      {
        question:
        ...
        answer: [
          ...
          `So you can see that virtuous cycle of design system feeding product and product feeding design system much more closely and much more frequently. Unlike some larger companies, these cycles are longer, and it's hard to see the impact. Many people will attribute impact to multiple things because the actual truth is: "yes, the design system helps our product, but so did the market, and so did this team's pace, and so did this new hire that we made here." So it's a lot more opaque to tie design system value directly to the design system.`,
        ],
      },
      {
        question:
      ...
      {
        question:
          "And have you been in situations when component requirements come from the product that conflict with the long-term design system vision or processes? How would you balance these requirements?",
        answer: [
          ...
          "It's risky when expectations from a product team are that the design system team will give them exactly what they need in the exact form they need. That's not a design system. That's s augmentation. And the same thing the other way around is if the design system team is expecting perfect contributions from a product team. That's not it either. That's the product team becoming a design system team. So it's somewhere in the middle between those two.",
        ],
      },
      {
        question:
        ...
        answer: [
          ...
          "A good modal for a design system team to follow is: as they are trying to reach out to their customers – they have to be proactive about it.",
        ],
      },
      {
        question:
        ...
        answer: [
          ...
          `It's reasonable to say a design system team cannot do everything and cannot serve everyone. However, we must define what "as many people as possible" actually means. Does that mean that of the hundred teams we're serving, we can only serve 10? What are our criteria for those 10? And that way is not about picking your most and least favorite teams. You know, we love them, and we hate them, but it's actually based on some objective criteria.`,
      ...
      },
      {
        ...
        answer: [
          `Yes. Ideally, for me and ideally for my prospective client, we identify that before we even start working together. Some clients come in and say: "This is how we want to do design system work." And that might be the opposite of how I would recommend doing it. So if we disagree on a specific way to do the work from the start – it's good for both sides choosing not to work together.`,
      ...
      },
      {
        ...
        answer: [
          ...
          "They're the ones that are always snooping in people's roadmaps and staying interested in what's coming up for those teams. And then, they find an opportunity to help those teams by staying ahead on certain topics. So they're able to look ahead, but they're also able to make those connections and get people to say confirm that they will spend time working with the design system team. That's a crucial skill.",
        ],
      },
      {
        question:
        ...
        answer: [
          ...
          "I've worked with teams who don't need buttons in their design system because it could be a better use of their time. Instead, they could focus on a data table, for example, because that's a thing that 60% of their teams use. And so they'll spend a lot of time on that, and their data table will be very different than the one that MUI supports or that Lightning Design System supports because their table is for banking and not for a public-facing website.",
      ...
      },
      {
        ...
        answer: [
          "It's tough. There are many things, but I'll narrow it down to one. All metrics are trailing indicators, so it's tough to measure them directly. But the one that I always look at first is I look at retention for teams that have worked with the design system or design system team and teams that haven't.",
      ...
      {
        question:
          "That's quite interesting, and it is the first time I have heard about someone measuring retention as a metric for the design team! Since we've started talking about craft, what do you think design system teams usually struggle with the most?",
        answer: [
      ...
      {
        question:
          "That's a great approach. How do you suggest teams keep following these as they grow? I've seen teams splitting design and engineering work sometimes, and some of the processes stop working so well because people get more isolated. What, in your experience, works better in those cases?",
        answer: [
      ...
      },
      {
        ...
        answer: [
          "I think the list of things they're not going to do should be longer than the list of things they are. When they're just starting, teams try to do everything. We're going to have 60 components, and we're going to have ten variants of each component, and it's going to be this great, amazing, big-scale system. But you have no idea whether or not that could be successful at this point. It's just too big of an ask. It's too big of a promise.",
